"""
📝 RealSense Camera Interface Module

This module provides a simple interface for working with the Intel RealSense
camera using the PyRealSense2 library. It allows you to initialize a camera,
...
class rsCamera:
    def __init__(self, resolution: tuple = (640, 480), fps: int = 30):
        """
        RealSense Camera class for simplified streaming and frame retrieval.
    ...
    def grabFrames(self):
        """
        Grabs frames from the RealSense camera.

        Returns
        -------
        frames: rs.frame
            The grabbed frame from the camera.
